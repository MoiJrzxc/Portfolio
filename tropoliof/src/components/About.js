        ...
        <div className="row">
          ...
          <div className="about-col-2">
            ...
            <div className={`tab-contents ${tab === 'skills' ? 'active-tab' : ''}`} id="skills">
              <ul>
                <li>
                  <span>Programming</span><br />Java, Python, JavaScript
                </li>
                <li>
